...
\sect{Neural Networks}\label{intro:nn}
...
\centering	
\end{figure}
\footnotetext[1]{Figure 1-1 by Egm4313.s12 (Prof. Loc Vu-Quoc) - Own work, CC BY-SA 4.0, \url{https://commons.wikimedia.org/w/index.php?curid=72816083}}
